...
(function (global) {
  ...
  Reader.prototype = {
    ...
    i64()  { const v = this.view.getBigInt64(this.pos); this.pos += 8; return v; },
  ...
  global.NBT = { parse, decompress, inflateIfNeeded, TAGS: {
